# Generated by Powerlevel10k configuration wizard on 2023-09-15 at 22:35 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='${P9K_GCLOUD_PROJECT_NAME//\%/%%}@${P9K_GCLOUD_ACCOUNT//\%/%%}'
