---
name: documentation
description: Guidance for structuring documentation such as README.md using the Diataxis framework. Use this skill when creating new docs (e.g: README), deciding where content belongs, reviewing documentation PRs, or restructuring existing documentation.
---
