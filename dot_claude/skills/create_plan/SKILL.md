...
1. **Write the plan** to `thoughts/tasks/TASKNAME/YYYY-MM-DD-plan.md`
   - Format: `thoughts/tasks/TASKNAME/YYYY-MM-DD-plan.md` where:
     - TASKNAME is the task directory (e.g., improve-error-handling)
...
- Related research: `thoughts/tasks/TASKNAME/YYYY-MM-DD-research.md`
...
1. **Present the draft plan location**:
   ...
   `thoughts/tasks/TASKNAME/YYYY-MM-DD-plan.md`
